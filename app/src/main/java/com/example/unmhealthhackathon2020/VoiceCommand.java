    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        voiceCommand.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(VoiceCommand.this,
                        Manifest.permission.RECORD_AUDIO)
                        != PackageManager.PERMISSION_GRANTED) {

                    // Permission is not granted
                    // Should we show an explanation?
                    if (ActivityCompat.shouldShowRequestPermissionRationale(VoiceCommand.this,
                            Manifest.permission.RECORD_AUDIO)) {
                        ...
                        ActivityCompat.requestPermissions(VoiceCommand.this,
...
//        Fourth: Open a browser and open url
        if(result_message.indexOf("what") != -1){
            if(result_message.indexOf("your name") != -1){
                speak("My Name is eleveight. Nice to meet you!");
            }
        ...
        } else if (result_message.indexOf("first floor") != -1){
            speak("Hold tight, going to first floor");

        } else if (result_message.indexOf("second floor") != -1){
            speak("Hold tight, going to second floor");

        } else if (result_message.indexOf("third floor") != -1){
            speak("Hold tight, going to third floor");

        } else if (result_message.indexOf("fourth floor") != -1){
            speak("Hold tight, going to fourth floor");
